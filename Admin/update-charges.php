...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($_POST['name']) && !empty($_POST['type'])) {
        ...
        $stmt = $conn->prepare("UPDATE room SET cost = ? WHERE room_type = ?");

        // Bind parameters
        $stmt->bind_param("is", $room_cost, $room_type);

        // Set parameters
        $room_cost = $_POST['name']; // Assuming the input field name for rate per night is 'name'
        ...
        try {
            ...
            if ($stmt->execute()) {
                ...
                if ($stmt->affected_rows > 0) {
                    ...
                    $error_message = "Error: Unable to update data.";
                }
            }
    ...
    <div class="bodywrapper">
        ...
        <div class="centercontent">
            ...
            <div class="pageheader notab">
                <h1 class="pagetitle">
                    Update Room Charges</h1>
                <span class="pagedesc"></span>
            </div><!--pageheader-->

            <div id="contentwrapper" class="contentwrapper">

                <form action="update-charges.php" method="post">
                    ...
                    <div class="two_third dashboard_left">
                        ...
                        <p>
                            <strong>Rate per night</strong><br />
                            <strong>$</strong>
                            <input type="text" name="name" id="name" value=".00" class="longinput" style="width:75px;" oninput="updateInput()" />
                            <!-- <input type="text" name="name" id="name" value="" class="longinput" style="width:75px;" /> -->
                        ...
                        <script>
                            function updateInput() {
                                ...
                                // Remove any non-numeric characters except for dot and the first dollar sign
                                value = value.replace(/[^\d.$]/g, "");

                                // Remove all but the first dollar sign
