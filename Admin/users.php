...
$sql = "SELECT admin_id, username, password,name,email,create_date FROM admin";
  ...
  <div class="bodywrapper">
    ...
    <div class="centercontent tables">
      ...
      <div class="pageheader notab">
        ...
        <form method="post">
          &nbsp;&nbsp;&nbsp;&nbsp;
          <button class="submit radius2" onclick="window.location='add-users.php'; return false;">Add User</button>
        </form>
          ...
          <tbody>
            ...
            if (!empty($rooms)) {
              ...
              foreach ($rooms as $row) {
                ...
                echo "<td class='con0' style='font-size: 12px;'>" . $row["username"] . "</td>";
                echo "<td class='con0' style='font-size: 12px;'>" . $row["name"] . "</td>";
                echo "<td class='con0' style='font-size: 12px;'>" . $row["email"] . "</td>";
