...
$sql = "SELECT room_no, room_type, create_date, status FROM roomlist";
    ...
    <div class="bodywrapper">
            ...
            <ul>
                <li class="current"><a href="#rtype" class="gallery">Rooms</a>
                    ...
                    <ul id="rtype">
                        ...
                        <li class="current"><a href="room.php">Rooms List</a></li>
                    </ul>
                </li>
        ...
        <div class="centercontent tables">
            ...
            <div class="pageheader notab">
                <h1 class="pagetitle">Rooms List</h1>

                <form method="post">
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <button class="submit radius2" onclick="window.location='add-room.php'; return false;">Add Room</button>
                </form>
            </div><!--pageheader-->
            ...
            <div id="contentwrapper" class="contentwrapper">
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablequick" id="dyntable1">
                    ...
                    <thead>
                        <tr>                            
                            <th class="head0" width="5%" style='font-size: 12px;'>Room No</th>
                    ...
                    <tbody>
                        ...
                        if (!empty($rooms)) {
                            ...
                            foreach ($rooms as $row) {
                                ...
                                echo "<td class='con0' style='font-size: 12px;'>" . $row["room_no"] . "</td>";
                                echo "<td class='con0' style='font-size: 12px;'>" . $row["room_type"] . "</td>";
                                echo "<td class='con0' style='font-size: 12px;'>" . $row["create_date"] . "</td>";
                                echo "<td class='con0' style='font-size: 12px;'><font color='#009900'>" . $row["status"] . "</font></td>";
                                //echo "<td class='con0'><font color='#009900'>Available</font></td>";
